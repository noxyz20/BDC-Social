...
<div class="bg-gray-900">
        <div class="flex">
            ...
            <div class="w-2/5 text-white h-12 pl-32 py-4 h-auto">
                <!--left menu-->
              <jet-application-mark  class="h-12 w-12 text-white" />
              <nav class="mt-5 px-2">
                <a :href="route('dashboard')" class="group flex items-center px-2 py-2 text-base leading-6 font-semibold rounded-full hover:bg-gray-800 hover:text-blue-300">
              <svg class="mr-4 h-6 w-6 " stroke="currentColor" fill="none" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l9-9 9 9M5 10v10a1 1 0 001 1h3a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1h3a1 1 0 001-1V10M9 21h6"/>
              </svg>
              Home
            </a>
                <a :href="route('profile.show')" class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-gray-800 hover:text-blue-300">
